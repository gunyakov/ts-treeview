...
var TreeList = /** @class */ (function () {
    ...
    TreeList.prototype._makeItem = function (item, itemID) {
        ...
        if (item.items) {
            ...
            if (item.icon) {
                span.append(makeEl("i", __spreadArray(__spreadArray([], item.icon, true), ["ic-w", "mx-1"], false)));
            }
            ...
            if (item.icon) {
                li.append(makeEl("i", __spreadArray(__spreadArray([], item.icon, true), ["ic-w", "mx-1"], false)));
            }
            li.append(item.text);
        }
        return li;
